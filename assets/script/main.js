window.onload = () => {
  ...
  document.querySelector("#tool").addEventListener("click", ()=>{
    ...
    // console.log(document.querySelector("#SME").checked);
    // console.log(document.querySelector("#plateform").checked);
    // console.log(document.querySelector("#text").value);
    document.querySelector("#send").addEventListener("click", ()=>{
      // console.log(document.querySelector("#SME").checked + ' SALPUT');
      // console.log(document.querySelector("#plateform").checked + ' SALPUT');
      // console.log(document.querySelector("#text").value + ' SALPUT');
      if ((!(document.querySelector("#SME").checked) && !(document.querySelector("#plateform").checked)) || (document.querySelector("#text").value=="")){
      ...
      // console.log(document.querySelector("#SME").checked + ' OuiBonjour');
      // console.log(document.querySelector("#plateform").checked + ' OuiBonjour');
      // console.log(document.querySelector("#text").value + ' OuiBonjour');
    });
